...
module.exports = function (stripeSecretKey) {
  ...
  function parseCard(card) {
    ...
    const brand = Brands[card.brand] || card.brand;
    return {
      brand: card.brand,
  ...
  const EU_COUNTRY_CODES = ['AT','BE','BG','HR','CY','CZ','DK','EE','FO','FI','FR','GF','DE','GI','GR','HU','IE','IM','IT','LV','LT','LU','MT','NL','PL','PT','RO','SK','SI','ES','SE','GB'];
