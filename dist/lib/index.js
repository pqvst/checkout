        ...
        async function manageSubscription(stripeCustomerId, opts = {}) {
            ...
            if (stripeCustomerId) {
                ...
                try {
                    ...
                    await stripe.customers.update(stripeCustomerId, { name, email, tax_exempt: tax_exempt, address: { line1: '', country, postal_code: postcode } });
                }
                catch (err) {
            ...
            if (!stripeCustomerId) {
                ...
                customer = await stripe.customers.create({ name, email, tax_exempt: tax_exempt, address: { line1: '', country, postal_code: postcode } });
